...
- ALWAYS attach `floor-template.png` (this folder) as the tile master, first.
  It is the canonical empty tile at the house's exact geometry, generated by
  `scripts/ctrl-s-floor-template.mjs`. Gemini ignores verbal descriptions of the
  tile's proportions — it copies them from an image. Skipping this produced a
  1.55:1 tile against a 1.91:1 floor, which cost a day of rerolls.
